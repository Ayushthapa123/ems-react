...
{showupdateform &&<div className={styles.form}>
  ...
  <TextField  className={styles.input} label="Email" variant="outlined" size='small' type='text' value={uemail} onChange={(e)=>setUemail(e.target.value)} required/>
...
<tr>
    ...
    <th>Name <IconButton size='small' onClick={(e)=>sortUsers(users,"name")}><TbSortAscending2/></IconButton> <IconButton size='small' onClick={(e)=>ReversesortUsers(users,"name")}><TbSortAscending2/></IconButton></th>
    <th>Email <IconButton size='small' onClick={(e)=>sortUsers(users,"email")}><TbSortAscending2/></IconButton> <IconButton size='small' onClick={(e)=>ReversesortUsers(users,"email")}><TbSortAscending2/></IconButton></th>
    <th>Password</th>
    <th>Role <IconButton size='small' onClick={(e)=>sortUsers(users,"role")}><TbSortAscending2/></IconButton> <IconButton size='small' onClick={(e)=>ReversesortUsers(users,"role")}><TbSortAscending2/></IconButton></th>
    <th>Update/Delete</th>
  </tr>
